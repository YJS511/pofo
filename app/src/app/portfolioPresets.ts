...
export const PORTFOLIO_PRESETS: PortfolioPreset[] = [
  ...
  // ═══════════════════════════════════════
  {
    ...
    state: {
      ...
      skills: 'C, Java, Python, JSP, SQL, Linux, 데이터구조, 소프트웨어공학, Git, REST API',
      ...
      projects: [{ name: '캡스톤디자인 — 캠퍼스 중고거래 플랫폼', period: '2024.03 ~ 2024.11', role: '풀스택 개발 (팀 4명, 기여도 40%)', tech: 'Java, JSP, MySQL, HTML/CSS, JavaScript', desc: '교내 학생 대상 중고 물품 거래 웹 플랫폼 설계 및 개발', result: '교내 SW 경진대회 대상 수상, 일일 활성 사용자 200명', repo: 'github.com/gildong-dev/campus-market', demo: '' }],
